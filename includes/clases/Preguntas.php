...
class Preguntas 
{
    ...
    function __construct($dificultad)
    {
       $preguntas= ["8"=> [
            ...
            ,new Pregunta("Despeje la variable x: (2-4x)-(3-4x)+ 4= -(-3+6x)+ x", 0)
            ,new Pregunta("Despeje la variable k: 0.09k + 0.13(k+300)= 61", 100)
            ...
            ,new Pregunta("Despeje la variable x: -[3x-(2x+5)]= -4-[3(2x-4)-3x]", "3/2")
            ,new Pregunta("Factorice: 6st+9t-10s-15", "(2s+3)(3t-5)")
            ,new Pregunta("Despeje la variable x: (x+3)(x-9)= 0", "{-3, 9}")
            ,new Pregunta("Resuelva: -2<sup>4</sup>", -16) 
         ] 
    ,"10"=> [
        ...
        ,new Pregunta("Resuelva la ecuación: 4[6 - 1(1 + 2m)] + 10m = 2(10-3m) + 8m ", 0) 
        ...
        ,new Pregunta("El valor numérico de P(x)= 2x<sup>5</sup> - 4x<sup>3</sup> + 5x - 6 para x=2", 36)    
     ]
     ,"12"=> [
        new Pregunta("Resuelva: √<sup>125</sup>/<sub>180<sub>", "5/6")
        ,new Pregunta("Resuelva utilizando factor común: 6(b + 4)<sup>3</sup> - 3(b+4) + 6a(b+4)<sup>2</sup>", "3(b+4)(2(b+4)^2 - 1 + 2a (b+4))")
        ...
        ,new Pregunta("Determine el valor numérico del polinomio: P(x)= 2x<sup>3</sup> - 3x<sup>2</sup> + 6x - 1 para x=0", -1)
        ...
        ,new Pregunta("Resuelva: 2<sup>3</sup> + 10 ÷ 2 + 5 * 3 + 4 - 5 * 2 - 8 + 4 * 2<sup>2</sup> - 16 ÷ 4 ", 26)  
     ]
    ]    ;
